...
def main(input_files, output_dir, tokenizer="codellama/CodeLlama-7b-hf", num_workers=32, num_consumers=8, upload_to_s3=False):
    ...
    for i in range(num_workers):
        ...
        t = threading.Thread(target=process_files, args=(input_files[start:end], buffer, tokenize, buffer_lock))
        t.start()
        threads.append(t)
...
if __name__ == "__main__":
    ...
    main(args.input_files, args.output_dir, args.tokenizer, args.num_workers, args.num_consumers, args.upload_to_s3)
